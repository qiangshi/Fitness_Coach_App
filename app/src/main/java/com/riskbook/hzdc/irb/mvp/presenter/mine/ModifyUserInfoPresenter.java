...
import com.riskbook.hzdc.irb.utils.BitmapUtils;
import com.riskbook.hzdc.irb.utils.SelectImageUtils;
import com.riskbook.hzdc.irb.utils.ToastUtils;
...
public class ModifyUserInfoPresenter extends BasePresenter<ModifyUserInfoView> {
    ...
    public void getUserInfo(){
        addSubscription(apiStores.requestUserInfo("", DataCacheManager.getToken()),
